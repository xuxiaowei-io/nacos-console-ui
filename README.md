<div align="center" style="text-align: center;">
    <h1>nacos-console-ui</h1>
    <h3>Nacos 前端项目（制作成 jar 包）</h3>
...
<div align="center" style="text-align: center;">
  ...
  <a target="_blank" href="https://s01.oss.sonatype.org/content/repositories/snapshots/io/xuxiaowei/nacos/nacos-sentinel">
    <img alt="snapshots" src="https://img.shields.io/maven-metadata/v?label=snapshots&metadataUrl=https://s01.oss.sonatype.org/content/repositories/snapshots/io/xuxiaowei/nacos/nacos-sentinel/maven-metadata.xml">
  </a>

  <a target="_blank" href="https://s01.oss.sonatype.org/content/repositories/releases/io/xuxiaowei/nacos/nacos-sentinel">
    <img alt="releases" src="https://img.shields.io/maven-metadata/v?label=releases&color=blue&metadataUrl=https://s01.oss.sonatype.org/content/repositories/releases/io/xuxiaowei/nacos/nacos-sentinel/maven-metadata.xml">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="GitHub stars" src="https://img.shields.io/github/stars/xuxiaowei-io/nacos-console-ui?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="GitHub forks" src="https://img.shields.io/github/forks/xuxiaowei-io/nacos-console-ui?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="GitHub watchers" src="https://img.shields.io/github/watchers/xuxiaowei-io/nacos-console-ui?logo=github">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/xuxiaowei-io/nacos-console-ui">
  </a>

  <a target="_blank" href="https://gitee.com/xuxiaowei-io/nacos-console-ui">
    <img alt="码云Gitee stars" src="https://gitee.com/xuxiaowei-io/nacos-console-ui/badge/star.svg?theme=blue">
  </a>

  <a target="_blank" href="https://gitee.com/xuxiaowei-io/nacos-console-ui">
    <img alt="码云Gitee forks" src="https://gitee.com/xuxiaowei-io/nacos-console-ui/badge/fork.svg?theme=blue">
  </a>

  <a target="_blank" href="https://gitlab.com/xuxiaowei-io/nacos-console-ui">
    <img alt="Gitlab stars" src="https://badgen.net/gitlab/stars/xuxiaowei-io/nacos-console-ui?icon=gitlab">
  </a>

  <a target="_blank" href="https://gitlab.com/xuxiaowei-io/nacos-console-ui">
    <img alt="Gitlab forks" src="https://badgen.net/gitlab/forks/xuxiaowei-io/nacos-console-ui?icon=gitlab">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="OSCS Status" src="https://www.oscs1024.com/platform/badge/xuxiaowei-io/nacos-console-ui.svg?size=small">
  </a>

  <a target="_blank" href="https://github.com/xuxiaowei-io/nacos-console-ui">
    <img alt="total lines" src="https://tokei.rs/b1/github/xuxiaowei-io/nacos-console-ui">
  </a>
...
- Maven 仓库
    - [快照版](https://s01.oss.sonatype.org/content/repositories/snapshots/io/xuxiaowei/nacos/nacos-sentinel)
        - 可下载最新的二进制快照（可直接运行的 jar 包）
    - [发布版](https://s01.oss.sonatype.org/content/repositories/releases/io/xuxiaowei/nacos/nacos-sentinel)
        - 暂未发布

## [流水线](https://framagit.org/xuxiaowei-io/nacos-console-ui/-/pipelines)
...
git remote add gitee https://gitee.com/xuxiaowei-io/nacos-console-ui.git

git remote add gitlab https://gitlab.com/xuxiaowei-io/nacos-console-ui.git

git remote add framagit https://framagit.org/xuxiaowei-io/nacos-console-ui.git

git remote add github https://github.com/xuxiaowei-io/nacos-console-ui.git

git remote add gitcode https://gitcode.net/xuxiaowei-io/nacos-console-ui.git
...
[![Stargazers over time](https://starchart.cc/xuxiaowei-io/nacos-console-ui.svg)](https://starchart.cc/xuxiaowei-io/nacos-console-ui)
